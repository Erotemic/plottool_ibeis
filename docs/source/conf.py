...
Notes:
    ...
    cd ~/code/ibeis/tpl/plottool_ibeis
    mkdir -p docs
    cd docs
    ...
    rm -rf ~/code/ibeis/tpl/plottool_ibeis/docs/source/auto
    cd ~/code/ibeis/tpl/plottool_ibeis/docs
    sphinx-apidoc --private --separate --force --output-dir ~/code/ibeis/tpl/plottool_ibeis/docs/source/auto ~/code/ibeis/tpl/plottool_ibeis/plottool_ibeis
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/plottool-ibeis/advanced/
        ...
        Enter the following information:
            Set the Repository NAME: plottool_ibeis
            Set the Repository URL: https://github.com/Erotemic/plottool_ibeis

        Make sure you have a .readthedocs.yml file

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/plottool-ibeis/integrations/create/
        ...
        Then go to
            ...
            https://github.com/Erotemic/plottool_ibeis/hooks
...
mod_dpath = join(repo_dpath, 'plottool_ibeis')
...
man_pages = [
    (master_doc, 'plottool_ibeis', 'plottool_ibeis Documentation', [author], 1)
]
